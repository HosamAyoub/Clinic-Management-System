...
Creating a clinic management system using **C** Linked-list (dynamic memory allocation), organized and linked multiple files. At the beginning of the system it asks the user to choose between admin mode and user mode.
